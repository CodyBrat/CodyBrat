"""Adapted from the Vikbg/Vikbg repository.

Original Copyright 2026 Vikbg.
SPDX-License-Identifier: Apache-2.0
This script comes from viktor_srhk (Vikbg): https://github.com/Vikbg/Vikbg
Keep the attribution notice from the NOTICE file when redistributing.
"""
...
# ⚠️  TODO: Replace with your actual birthday!
# Format: datetime.datetime(YEAR, MONTH, DAY)
# This is used to calculate the "Uptime" field on the SVG card.
BIRTHDAY = datetime.datetime(2003, 1, 1)

ARCHIVE_USER_ID = ""  # Archive feature disabled. Set to your GitHub node ID to enable.
...
# 4. merge archived repository stats when applicable (disabled by default)
...
def main():
    ...
    # Archive feature: only triggers if ARCHIVE_USER_ID matches your GitHub node ID.
    # Set ARCHIVE_USER_ID at the top of this file and create cache/repository_archive.txt to enable.
    if OWNER_ID == ARCHIVE_USER_ID and ARCHIVE_USER_ID:
